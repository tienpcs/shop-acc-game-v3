...
<title>Lịch sử đơn cày thuê</title>
<?php checklogin();?>
                                                                        ...
                                                                        <div class="el-scrollbar__view"
                                                                            ...
                                                                            <table class="el-table__body"
                                                                                ...
                                                                                <tbody tabindex="-1">
                                                                                    <?php
                                    $i = 1;
                                    $result = mysqli_query($ketnoi, "SELECT * FROM `don_caythue` where `username`= '$username' ");
                                    while ($row = mysqli_fetch_assoc($result)) { 
                                    $loai_don = getdon($row['loai'], 'loai');
                                    ?>
                                                                                    <tr class="el-table__row">
                                                                                        <td class="el-table_1_column_1 el-table__cell"
                                                                                            ...
                                                                                            <div class="cell">
                                                                                                ...
                                                                                                <div>
                                                                                                    <p
                                                                                                        class="ws-font-semibold ws-text-red-500">
                                                                                                       <?=getloai($loai_don, 'name');?> - <?=getdon($row['loai'], 'ten');?>
                                                                                                    </p>
                                                                                                         <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <p
                                                                                                            ...
                                                                                                            TK: <span
                                                                                                                class="ws-text-zinc-900"><?=$row['taikhoan'];?></span>
                                                                                                        </p>
                                                                                                        <p
                                                                                                            class="ws-font-medium">
                                                                                                            MK: <span
                                                                                                                class="ws-text-zinc-900"><?=$row['matkhau'];?></span>
                                                                                                        </p>
                                                                                                        <p
                                                                                                            class="ws-font-medium">
                                                                                                            2FA: <span
                                                                                                                class="ws-text-zinc-900"><?=$row['2fa'];?></span>
                                                                                                        </p>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
