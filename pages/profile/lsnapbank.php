...
<title>Lịch sử nạp bank/ Momo</title>
<?php checklogin();?>
                                                                        ...
                                                                        <div class="el-scrollbar__view"
                                                                            ...
                                                                            <table class="el-table__body"
                                                                                ...
                                                                                <tbody tabindex="-1">
                                                                                    <?php
                                    $i = 1;
                                    $result = mysqli_query($ketnoi, "SELECT * FROM `history_nap_bank` where `username`= '$username' ");
                                                                                            ...
                                                                                            <div class="cell">
                                                                                                ...
                                                                                                <div>
                                                                                                    <div>
                                                                                                        <span
                                                                                                            type="span"
                                                                                                            class="ws-text-white ws-px-3 ws-font-medium ws-rounded ws-bg-green-500 ws-text-xs ws-inline-block ws-py-1">Thành
                                                                                                            Công</span>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="ws-border-b ws-border-dashed ws-w-20 ws-my-2">
