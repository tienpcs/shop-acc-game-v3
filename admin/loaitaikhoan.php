...
if (isset($_GET['del'])) {
    $del = $_GET['del'];
    echo '<script> if (confirm("Bạn có chắc muốn xoá loại tài khoản này")) {
...
if (isset($_GET['delete'])) 
{
    ...
    $create = mysqli_query($ketnoi,"DELETE FROM `loai_tai_khoan` WHERE `id` = '".$delete."' ");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Danh sách loại tài khoản</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Danh sách loại tài khoản</h3>
                                    <div class="text-right">
                                        <a class="btn btn-primary btn-icon-left m-b-10" href="add-loai-tai-khoan.php"
                                            type="button"><i class="fas fa-plus-circle mr-1"></i>Thêm loại tài khoản</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="datatable1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?=$row['id'];?></td>
                                                    <td>
                                                        <img class="card-img-top rounded" style="width: 100px;"
                                                    ...
                                                    <td><?=$row['status'];?></td>
                                                    <td>
                                                        <a href="edit-loai.php?id=<?=$row['id'];?>"
