...
if (isset($_GET['delete'])) 
{
    ...
    $create = mysqli_query($ketnoi,"DELETE FROM `list_game` WHERE `id` = '".$delete."' ");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Danh sách game</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="text-right">
                                        <a class="btn btn-primary btn-icon-left m-b-10" href="add-game.php"
                                            type="button"><i class="fas fa-plus-circle mr-1"></i>Thêm game</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                $lines = explode("\n", $row['list_thong_tin']); 
                                                   ...
                                                   <?=trim($line);?></br>
                                                    ...
                                                    <td><?=$row['status'];?></td>
                                                    <td>
                                                        <a href="edit-game.php?id=<?=$row['id'];?>"
