...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $toz_game =  $ketnoi->query("SELECT * FROM `list_game` WHERE `id` = '$id' ")->fetch_array();
}
?>
<?php
if (isset($_POST["submit"]))
{
  $create = mysqli_query($ketnoi,"UPDATE `list_game` SET 
    `name` = '".$_POST['name']."',
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-container">
                                                <textarea class="form-control" name="list_thong_tin"
                                                    placeholder="Mỗi thông tin 1 dòng, Vd: Tướng "
                                                    rows="6"><?=$toz_game['list_thong_tin'];?></textarea>
                                            </div>
                                        </div>
